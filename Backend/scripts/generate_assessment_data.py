...
SCALE_DEFINITIONS = {
    ...
    "SDS": {
        ...
        "risk_weights": {"normal": 0.40, "mild": 0.25, "moderate": 0.18,
                         "severe": 0.12, "very_severe": 0.05},
    },
}
...
RECOMMENDATIONS = {
    ...
    "SDS": {
        "正常": "您的抑郁状态处于正常范围，保持积极的生活方式即可。",
        "轻度抑郁": "建议增加户外活动，培养兴趣爱好，与亲友保持联系。如果持续超过两周未改善，请考虑咨询专业人士。",
        "中度抑郁": "建议尽快联系心理咨询师，制定系统的心理干预方案。同时注意规律作息，避免独处。",
        "重度抑郁": "请务必前往医院精神科就诊，可能需要结合药物和心理治疗。请告知身边信任的人以获得支持。",
        "极重度抑郁": "这是一个需要立即关注的状态。请联系精神科医生或拨打心理援助热线。您并不孤单，专业的帮助可以有效改善这一状况。",
    },
}
